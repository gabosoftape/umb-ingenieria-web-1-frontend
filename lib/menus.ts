  ...
  return [
    {
      ...
      menus: [
        {
          id: "dashboard",
          href: `${brandConfig.mainRoute}/analytics`,
          label: t("dashboard"),
      ...
      menus: [
        {
          ...
          label: "Usuarios",
          active: pathname.includes("/settings/admin/users"),
        ...
        },
        {
          ...
          label: "Cuentas",
          active: pathname.includes("/settings/admin/accounts"),
        ...
        },
        {
          ...
          href: "/settings/blogs",
          label: "Blogs",
          active: pathname.includes("/settings/blogs"),
